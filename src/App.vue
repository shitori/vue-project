...
<template>
  ...
  <main class="container mt-6">
    <div class="has-text-centered">
      ...
      <a class="button is-primary is-outlined is-large m-1"
        href="http://172.27.0.229:8080/jenkins2/view/FCC%20GUI%20-%20Tests%20Robot%20Framework/"
        target="_blank">Jenkins</a>
      <a class="button is-primary is-outlined is-large m-1"
        href="https://testmanagement.factory.orange-business.com/squash/campaign-workspace/campaign-folder/13627/content"
        target="_blank">Squash</a>
    </div>
