...
export default {
  ...
  methods: {
    ...
    callAPIUpdateSquash(e) {
      ...
      fetch('http://localhost:3001/api/rf2squashnofile', { method: 'POST', body: formData })
        ...
        .then(res => {
          ...
          componentsVisibility.setResultUST(true)
          console.error(err)
          store.setFromJson({ 'message': 'Fail call api', 'moreInfo': err, 'result': [] })
        })
  ...
  <div class="box mt-6 has-text-centered">
    ...
    <div class="has-text-left">
      <div class="field">
        ...
        <div class="control">
          <input class="input" type="text" id="inputUrlResult" v-model="inputUrlResult" placeholder="https://...">
        </div>
        ...
        <div class="control">
          <div class="file is-info has-name" id="file-js-example">
            <label class="file-label">
              <input class="file-input" type="file" id="inputFileResult" @change="updateNameFile" accept=".xml">
              <span class="file-cta">
      ...
      <div class="field">
        ...
        <div class="control">
          <input class="input" type="text" placeholder="v0,v1,v2 ..." id="inputCible" v-model="inputCible">
        </div>
        <p class="help">Fichier output.xml, si vide récupère les valeurs par défaut de l'API</p>
      </div>
      ...
      <div class="field">
        <div class="control">
          <label class="checkbox">
            <input type="checkbox" id="inputIsNGP" v-model="inputIsNGP">
            Cible : NGP ?
          </label>
        </div>
      </div>
      ...
      <div class="field">
        <div class="control">
          <label class="checkbox">
            <input type="checkbox" id="inputUpdateUntestable" v-model="inputUpdateUntestable">
    ...
    <button class="button is-primary is-outlined is-medium m-1 " @click="callAPIUpdateSquash">Robot
      Framework ➡️ Squash
    </button>
