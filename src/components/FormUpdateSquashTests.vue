  ...
  <div class="box mt-6 has-text-centered">
    ...
    <div class="has-text-left">
      <div class="field">
        ...
        <div class="control">
          <input
            ...
            type="text"
            id="inputUrlResult"
            v-model="inputUrlResult"
            placeholder="https://..."
          />
        </div>
        <p class="help">
          Fichier output.xml, si vide récupère les valeurs du champ "Fichier
          résultat Robot Framework"
        </p>
      </div>
      ...
      <div class="field">
        ...
        <p class="help">
          Fichier output.xml, si vide récupère les valeurs par défaut de l'API
        </p>
      </div>
      ...
      <div class="field">
        <div class="control">
          <label class="checkbox">
            <input
              type="checkbox"
              id="inputUpdateUntestable"
              v-model="inputUpdateUntestable"
            />
    ...
    <button
      class="button is-primary is-outlined is-medium m-1"
      @click="callAPIUpdateSquash"
    >
      Robot Framework ➡️ Squash
    </button>
  </div>
</template>
